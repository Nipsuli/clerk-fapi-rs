...
pub struct ClientPeriodSessionReverification {
    ...
    pub session: Box<models::ClientSessionReverificationSession>,
}

impl ClientPeriodSessionReverification {
    pub fn new(
        object: Object,
        level: String,
        status: Status,
        ...
        >,
        session: models::ClientSessionReverificationSession,
    ) -> ClientPeriodSessionReverification {
        ClientPeriodSessionReverification {
            object,
            level,
            status,
