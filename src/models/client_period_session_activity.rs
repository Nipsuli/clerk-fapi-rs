...
pub struct ClientPeriodSessionActivity {
    #[serde(rename = "object")]
    pub object: String,
    #[serde(rename = "id")]
    pub id: String,
...
impl ClientPeriodSessionActivity {
    pub fn new(object: String, id: String, is_mobile: bool) -> ClientPeriodSessionActivity {
        ClientPeriodSessionActivity {
            object,
            id,
            device_type: None,
            is_mobile,
